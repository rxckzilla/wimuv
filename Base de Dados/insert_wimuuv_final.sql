...
insert into org (org_name, org_initials) values('Luzinete Takara', 'LT');
...
insert into student_course (stu_course_name) values('Design');
...
insert into student_rate (stu_rate_ev,stu_rate_comment, stu_rid, ev_rid) values (7,'bom evento e spot acolhedor',1,1);
insert into student_rate (stu_rate_ev,stu_rate_comment, stu_rid, ev_rid) values (8,'boa organizacao',2,1);
